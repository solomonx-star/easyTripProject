    ...
    <NavBarWrapper>
      <div className="relative">
        ...
        <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col justify-center items-center text-white">
          ...
          <p className="mt-2 text-lg">Revolutionazing Transportation System In Sierra Leone </p>
        </div>
      </div>
        ...
        <div className="bg-white-600 text-black shadow-lg rounded-lg p-6 flex flex-col justify-center">
          ...
          <div className="space-y-4">
            <p className="flex items-center">
              <span className="material-icons-outlined mr-2">phone</span> +23230223581
            </p>
            <p className="flex items-center">
              <span className="material-icons-outlined mr-2">email</span> easytrip.com
            </p>
            <p className="flex items-center">
              <span className="material-icons-outlined mr-2">location_on</span> 12 Freeetown HighWay Makeni
            </p>
          </div>
        </div>
      </div>
