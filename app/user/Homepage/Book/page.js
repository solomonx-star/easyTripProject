        ...
        <div className="flex-1">
          <div className="md:bg-white bg-white md:px-4 p-3">
            ...
            <select  name="passenger"
                value={passenger}
                onChange={handleChange} className="w-full rounded-lg focus:outline-none focus:border-teal-500">
            ...
            {filteredResults.length > 0 ? (
              ...
              <thead className="">
                <tr>
                  ...
                  <th className="border-b  px-4 py-2 text-center font-bold">Price</th>
                ...
                {filteredResults.map((item, idx) => (
                  <tr key={idx} className="hover:bg-gray-100">
                    ...
                    <td className="px-4 py-5 flex flex-col gap-10 items-center">
                      <p>Nle {item.price}</p>
                      <button onClick={() => handleDetails(item)} className="bg-[#189AA7] text-white px-6 py-2 rounded-md shadow-sm">
                        View Seats
                      </button>
                    </td>
